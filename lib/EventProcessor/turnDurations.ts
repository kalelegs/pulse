import { createDuration } from '@/lib/chatMessage';
import type { TDuration, TMessageSink } from '@/types';
 ...
 * of `docs/fixtures/events.log.json`), so `audioEnd` has to be upserted onto the transcript afterwards rather
