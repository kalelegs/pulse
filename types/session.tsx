...
export type TUseSessionRetval = {
   ...
   * is given to `session.sendMessage`, so narrowing here to the text case (as this used to) made
   * the multi-modal `input_image` branch unreachable through the hook for no reason other than
   * that today's callers happen to send text.
   */
