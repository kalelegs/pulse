...
const rendererMap: TRendererMap = {
  ...
  'conversation.item.added': (event) =>
    renderConversationItemAdded(event as TConversationItemAddedEvent),
  'conversation.item.done': (event) =>
    renderConversationItemDone(event as TConversationItemDoneEvent),
  'conversation.item.retrieved': (event) =>
    renderConversationItemRetrieved(event as TConversationItemRetrievedEvent),
  ...
  'conversation.item.input_audio_transcription.completed': (event) =>
    renderInputAudioTranscriptionCompleted(
      event as TConversationInputAudioTranscriptionCompletedEvent,
    ),
  'input_audio_buffer.committed': (event) =>
    renderInputAudioBufferCommitted(event as TInputAudioBufferCommittedEvent),
  ...
  'output_audio_buffer.started': (event) =>
    renderOutputAudioBufferStarted(event as TOutputAudioBufferStartedEvent),
  'output_audio_buffer.stopped': (event) =>
    renderOutputAudioBufferStopped(event as TOutputAudioBufferStoppedEvent),
  ...
  'response.output_item.added': (event) =>
    renderResponseOutputItemAdded(event as TResponseOutputItemAddedEvent),
  'response.output_item.done': (event) =>
    renderResponseOutputItemDone(event as TResponseOutputItemDoneEvent),
  'response.content_part.added': (event) =>
    renderResponseContentPartAdded(event as TResponseContentPartAddedEvent),
  'response.content_part.done': (event) =>
    renderResponseContentPartDone(event as TResponseContentPartDoneEvent),
  ...
  'response.output_audio.done': (event) =>
    renderResponseOutputAudioDone(event as TResponseOutputAudioDoneEvent),
